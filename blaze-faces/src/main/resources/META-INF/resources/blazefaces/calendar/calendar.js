/**
 * BlazeFaces Calendar Widget
 */
BlazeFaces.widget.Calendar = BlazeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        if(this.cfg.popup) {
            BlazeFaces.skinInput(this.jqEl);

            if(this.cfg.behaviors) {
                BlazeFaces.attachBehaviors(this.jqEl, this.cfg.behaviors);
            }

            this.cfg.beforeShow = function() {
                setTimeout(function() {
                    $('#ui-datepicker-div').css('z-index', ++BlazeFaces.zindex);
                }, 250);
            };
        }
        ...
        if(this.cfg.popup && this.cfg.showOn) {
            ...
            BlazeFaces.skinButton(triggerButton);
        }
    ...
    configureLocale: function() {
        var localeSettings = BlazeFaces.locales[this.cfg.locale];
