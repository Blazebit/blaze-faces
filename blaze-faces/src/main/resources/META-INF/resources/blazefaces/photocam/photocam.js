...
/**
* BlazeFaces PhotoCam Widget
*/
BlazeFaces.widget.PhotoCam = BlazeFaces.widget.BaseWidget.extend({
    ...
    createPostData: function() {
        ...
        params[BlazeFaces.PARTIAL_REQUEST_PARAM] = true;
        params[BlazeFaces.PARTIAL_PROCESS_PARAM] = process;
        params[BlazeFaces.PARTIAL_SOURCE_PARAM] = this.id;
        params[this.id] = this.canvas.toDataURL('image/png');

        if(this.cfg.update) {
            params[BlazeFaces.PARTIAL_UPDATE_PARAM] = this.cfg.update;
        }
