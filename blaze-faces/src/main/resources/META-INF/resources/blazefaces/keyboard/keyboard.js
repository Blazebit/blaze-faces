...
/**
 * BlazeFaces Keyboard Widget
 */
 BlazeFaces.widget.Keyboard = BlazeFaces.widget.BaseWidget.extend({
    
    init: function(cfg) {
        this._super(cfg);
        
        if(this.cfg.layoutTemplate)
            this.cfg.layout = BlazeFaces.widget.KeyboardUtils.createLayoutFromTemplate(this.cfg.layoutTemplate);
        else
            this.cfg.layout = BlazeFaces.widget.KeyboardUtils.getPresetLayout(this.cfg.layoutName);
...
BlazeFaces.widget.KeyboardUtils = {
