/**
 * BlazeFaces DataTable Widget
 */
BlazeFaces.widget.DataTable = BlazeFaces.widget.BaseWidget.extend({
    ...
    setupPaginator: function() {
        ...
        this.paginator = new BlazeFaces.widget.Paginator(this.cfg.paginator);
    },
    ...
    isSelected: function(rowIndex) {
        return BlazeFaces.inArray(this.selection, rowIndex);
    },
