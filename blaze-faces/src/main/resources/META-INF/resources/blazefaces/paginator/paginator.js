BlazeFaces.widget.Paginator = function(cfg){
    this.cfg = cfg;
    this.jq = $();
    
    var _self = this;
    $.each(this.cfg.id, function(index, id){
        _self.jq = _self.jq.add($(BlazeFaces.escapeClientId(id)));
    });
...
BlazeFaces.widget.Paginator.prototype.bindEvents = function(){
    var _self = this;
    ...
    BlazeFaces.skinSelect(this.rppSelect);
    ...
    //jump to page
    BlazeFaces.skinSelect(this.jtpSelect);
...
BlazeFaces.widget.Paginator.prototype.bindPageLinkEvents = function(){
    var _self = this;
...
BlazeFaces.widget.Paginator.prototype.updateUI = function() {  
    //boundaries
    if(this.cfg.page == 0) {
...
BlazeFaces.widget.Paginator.prototype.updatePageLinks = function() {
    var start, end, delta;
...
BlazeFaces.widget.Paginator.prototype.setPage = function(p, silent) {
...
BlazeFaces.widget.Paginator.prototype.setRowsPerPage = function(rpp) {
...
BlazeFaces.widget.Paginator.prototype.setTotalRecords = function(value) {
...
BlazeFaces.widget.Paginator.prototype.getCurrentPage = function() {
