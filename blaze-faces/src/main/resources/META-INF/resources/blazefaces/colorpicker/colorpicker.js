...
/**
 * BlazeFaces Color Picker Widget
 */
 BlazeFaces.widget.ColorPicker = BlazeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        //popup ui
        if(this.cfg.popup) {
            BlazeFaces.skinButton(this.jqEl);
            this.overlay = $(BlazeFaces.escapeClientId(this.jqEl.data('colorpickerId')));
    ...
    bindCallbacks: function() {
        ...
        this.cfg.onShow = function() {
            if(_self.cfg.popup) {
                _self.overlay.css('z-index', ++BlazeFaces.zindex);
            }
