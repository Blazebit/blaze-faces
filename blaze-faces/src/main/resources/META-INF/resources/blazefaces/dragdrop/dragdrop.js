/**
 * BlazeFaces Draggable Widget
 */
BlazeFaces.widget.Draggable = BlazeFaces.widget.BaseWidget.extend({
    
    init: function(cfg) {
        this.cfg = cfg;
        this.id = this.cfg.id;
        this.jqId = BlazeFaces.escapeClientId(this.id);
        this.jq = $(BlazeFaces.escapeClientId(this.cfg.target));
...
/**
 * BlazeFaces Droppable Widget
 */
BlazeFaces.widget.Droppable = BlazeFaces.widget.BaseWidget.extend({
