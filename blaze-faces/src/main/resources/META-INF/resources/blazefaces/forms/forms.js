...
BlazeFaces.widget.InputText = BlazeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        if(this.cfg.behaviors) {
            BlazeFaces.attachBehaviors(this.jq, this.cfg.behaviors);
        }

        //Visuals
        BlazeFaces.skinInput(this.jq);
    }
});

/**
 * BlazeFaces InputTextarea Widget
 */
BlazeFaces.widget.InputTextarea = BlazeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        //Counter
        if(this.cfg.counter) {
            this.counter = this.cfg.counter ? $(BlazeFaces.escapeClientId(this.cfg.counter)) : null;
    ...
    refresh: function(cfg) {
        ...
        if(cfg.autoComplete) {
            $(BlazeFaces.escapeClientId(cfg.id + '_panel')).remove();
            $(BlazeFaces.escapeClientId('textarea_simulator')).remove();
        }
    ...
    search: function(query) {
            ...
            onsuccess: function(responseXML) {
                ...
                for(var i=0; i < updates.length; i++) {
                    ...
                    if(id == _self.id) {
                        ...
                        BlazeFaces.ajax.AjaxUtils.updateElement.call(this, id, data);
                    }
                }
        ...
        BlazeFaces.ajax.AjaxRequest(options);
    },
...
/**
 * BlazeFaces SelectOneMenu Widget
 */
BlazeFaces.widget.SelectOneMenu = BlazeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        //mark trigger and descandants of trigger as a trigger for a blazefaces overlay
        this.triggers.data('blazefaces-overlay-target', true).find('*').data('blazefaces-overlay-target', true);
        ...
        //pfs metadata
        this.input.data(BlazeFaces.CLIENT_ID_DATA, this.id);
    },
    ...
    show: function() {
        ...
        this.panel.css('z-index', ++BlazeFaces.zindex);

        if($.browser.msie && /^[6,7]\.[0-9]+/.test($.browser.version)) {
            this.panel.parent().css('z-index', BlazeFaces.zindex - 1);
        }
...
BlazeFaces.widget.SelectOneRadio = BlazeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        //pfs metadata
        this.inputs.data(BlazeFaces.CLIENT_ID_DATA, this.id);
    },
    ...
    bindEvents: function() {
        ...
        this.labels.click(function(e) {
            var target = $(BlazeFaces.escapeClientId($(this).attr('for'))),
            radio = null;
...
BlazeFaces.widget.SelectManyCheckbox = BlazeFaces.widget.BaseWidget.extend({
    ...
    bindEvents: function() {        
        ...
        if(this.cfg.behaviors) {
            ...
            /**
 * BlazeFaces SelectListbox Widget
 */
BlazeFaces.widget.SelectListbox = BlazeFaces.widget.BaseWidget.extend({
...
/** 
 * BlazeFaces CommandButton Widget
 */
BlazeFaces.widget.CommandButton = BlazeFaces.widget.BaseWidget.extend({
    
    init: function(cfg) {
        this._super(cfg);
        
        BlazeFaces.skinButton(this.jq);
    },
...
/*
 * BlazeFaces Button Widget
 */
BlazeFaces.widget.Button = BlazeFaces.widget.BaseWidget.extend({
...
/**
 * BlazeFaces SelecyManyButton Widget
 */
BlazeFaces.widget.SelectManyButton = BlazeFaces.widget.BaseWidget.extend({
...
/**
 * BlazeFaces SelectOneButton Widget
 */
BlazeFaces.widget.SelectOneButton = BlazeFaces.widget.BaseWidget.extend({
...
/**
 * BlazeFaces SelectBooleanButton Widget
 */
BlazeFaces.widget.SelectBooleanButton = BlazeFaces.widget.BaseWidget.extend({
...
/** 
 * BlazeFaces SelectCheckboxMenu Widget
 */
BlazeFaces.widget.SelectCheckboxMenu = BlazeFaces.widget.BaseWidget.extend({
    ...
    bindEvents: function() {
        ...
        //Filter
        if(this.cfg.filter) {
            BlazeFaces.skinInput(this.filterInput);
...
/**
 * BlazeFaces InputMask Widget
 */
BlazeFaces.widget.InputMask = BlazeFaces.widget.BaseWidget.extend({
 ...
 * BlazeFaces Password
 */
BlazeFaces.widget.Password = BlazeFaces.widget.BaseWidget.extend({
...
/**
 * BlazeFaces DefaultCommand Widget
 */
BlazeFaces.widget.DefaultCommand = BlazeFaces.widget.BaseWidget.extend({
    
    init: function(cfg) {
        this.cfg = cfg;
        this.id = this.cfg.id;
        this.jqId = BlazeFaces.escapeClientId(this.id);
        this.jqTarget = $(BlazeFaces.escapeClientId(this.cfg.target));
        this.scope = this.cfg.scope ? $(BlazeFaces.escapeClientId(this.cfg.scope)) : null;
        var _self = this;
...
/*
 * BlazeFaces SplitButton Widget
 */
BlazeFaces.widget.SplitButton = BlazeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        //pfs metadata
        this.button.data(BlazeFaces.CLIENT_ID_DATA, this.id);
        this.menuButton.data(BlazeFaces.CLIENT_ID_DATA, this.id);
    },
    
    //override
    refresh: function(cfg) {
        //remove previous overlay
        $(document.body).children(BlazeFaces.escapeClientId(cfg.id + '_menu')).remove();
    ...
    bindEvents: function() {  
        ...
        BlazeFaces.skinButton(this.button).skinButton(this.menuButton);

        //mark button and descandants of button as a trigger for a blazefaces overlay
        this.button.data('blazefaces-overlay-target', true).find('*').data('blazefaces-overlay-target', true);
    ...
    alignPanel: function() {
        ...
        this.menu.css({left:'', top:'','z-index': ++BlazeFaces.zindex}).position(this.cfg.position);
    }
