/**
 * BlazeFaces Wizard Component
 */
BlazeFaces.widget.Wizard = BlazeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        if(this.cfg.showNavBar) {
            ...
            //visuals
            BlazeFaces.skinButton(this.backNav);
            BlazeFaces.skinButton(this.nextNav);
    ...
    loadStep: function(stepToGo, isBack) {
        ...
        var options = {
            ...
            error: function() {
                BlazeFaces.error('Error in loading dynamic tab content');
            }
        };
