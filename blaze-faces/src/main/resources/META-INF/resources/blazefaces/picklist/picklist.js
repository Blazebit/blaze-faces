/**
 * BlazeFaces PickList Widget
 */
BlazeFaces.widget.PickList = BlazeFaces.widget.BaseWidget.extend({
    ...
    bindButtonEvents: function() {
        ...
        //visuals
        BlazeFaces.skinButton(this.jq.find('.ui-button'));
    ...
    bindFilterEvents: function() {
        ...
        BlazeFaces.skinInput(this.sourceFilter);
        BlazeFaces.skinInput(this.targetFilter);
