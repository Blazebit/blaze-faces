 ...
 */
package com.blazebit.blazefaces.push;
 ...
 */
public class BlazeAtmosphereHandler extends AbstractReflectorAtmosphereHandler {

    private final List<PushRule> rules;

    public BlazeAtmosphereHandler(List<PushRule> rules) {
        this.rules = rules;
    }

    public void onRequest(AtmosphereResource resource) throws IOException {
        AtmosphereRequest r = resource.getRequest();
        // We only handle GET. POST are supported by BlazeFaces directly via the Broadcaster.
