...
public class MessageFactory {
	...
	private static String BLAZEFACES_BUNDLE_BASENAME = "com.blazebit.blazefaces.Messages";
	...
	public static FacesMessage getMessage(Locale locale, String messageId, Object params[]) {
        ...
        //try blazefaces bundle
        if(summary == null) {
        	try {
				bundle = ResourceBundle.getBundle(BLAZEFACES_BUNDLE_BASENAME, locale, getCurrentClassLoader(BLAZEFACES_BUNDLE_BASENAME));
				if (bundle == null) {
