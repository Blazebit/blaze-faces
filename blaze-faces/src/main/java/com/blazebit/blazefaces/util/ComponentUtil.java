...
public class ComponentUtil {
    ...
    public static String findClientIds(FacesContext facesContext, UIComponent component, Collection<String> ids) {
        if (ids == null) {
            return "@none";
        }
        ...
        for (Iterator<String> idIter = ids.iterator(); idIter.hasNext();) {
            ...
            if (id.equals("@all") || id.equals("@none")) {
                ...
                UIComponent form = ComponentUtil.findParentForm(facesContext, component);
