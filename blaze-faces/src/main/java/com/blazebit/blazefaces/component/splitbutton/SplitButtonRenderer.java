 ...
 */
package com.blazebit.blazefaces.component.splitbutton;
...
import com.blazebit.blazefaces.component.commandbutton.CommandButtonRenderer;
import com.blazebit.blazefaces.component.menu.AbstractMenu;
import com.blazebit.blazefaces.component.menu.Menu;
import com.blazebit.blazefaces.component.menubutton.MenuButton;
...
public class SplitButtonRenderer extends CommandButtonRenderer {
	...
	protected void encodeScript(FacesContext context, SplitButton button) throws IOException {
        ...
        writer.write("BlazeFaces.cw('SplitButton','" + button.resolveWidgetVar() + "',{");
