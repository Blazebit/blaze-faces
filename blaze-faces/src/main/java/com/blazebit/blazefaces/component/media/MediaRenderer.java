 ...
 */
package com.blazebit.blazefaces.component.media;
...
import com.blazebit.blazefaces.component.media.player.MediaPlayer;
import com.blazebit.blazefaces.component.media.player.MediaPlayerFactory;
	...
	protected String getMediaSrc(FacesContext context, Media media) {
        ...
        if(value == null) {
            ...
            if(value instanceof StreamedContent) {
                ...
                Resource resource = context.getApplication().getResourceHandler().createResource("dynamiccontent", "blazefaces", streamedContent.getContentType());
