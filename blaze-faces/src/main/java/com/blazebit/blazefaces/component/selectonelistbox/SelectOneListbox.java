...
public class SelectOneListbox extends HtmlSelectOneListbox implements ClientBehaviorHolder {
    ...
    public static final String COMPONENT_TYPE = "com.blazebit.blazefaces.component.SelectOneListbox";
    public static final String COMPONENT_FAMILY = "com.blazebit.blazefaces.component";
    private static final String DEFAULT_RENDERER = "com.blazebit.blazefaces.component.SelectOneListbox";
