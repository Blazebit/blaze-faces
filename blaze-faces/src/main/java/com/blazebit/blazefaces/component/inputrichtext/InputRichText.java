...
public class InputRichText extends HtmlInputTextarea implements ClientBehaviorHolder {
    ...
    public static final String COMPONENT_TYPE = "com.blazebit.blazefaces.component.InputRichText";
    public static final String COMPONENT_FAMILY = "com.blazebit.blazefaces.component";
    private static final String DEFAULT_RENDERER = "com.blazebit.blazefaces.component.InputRichTextRenderer";
