 ...
 */
package com.blazebit.blazefaces.component.captcha;
...
public class CaptchaRenderer extends CoreRenderer {
	...
	public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
        ...
        if(publicKey == null) {
            throw new FacesException("Cannot find public key for catpcha, use blazefaces.PUBLIC_CAPTCHA_KEY context-param to define one");
        }
