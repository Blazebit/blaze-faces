 ...
 */
package com.blazebit.blazefaces.component.dashboard;
...
import com.blazebit.blazefaces.component.panel.Panel;
...
public class DashboardRenderer extends CoreRenderer {
	...
	protected void encodeScript(FacesContext context, Dashboard dashboard) throws IOException {
        ...
        writer.write("BlazeFaces.cw('Dashboard','" + dashboard.resolveWidgetVar() + "',{");
