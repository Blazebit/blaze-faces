 ...
 */
package com.blazebit.blazefaces.component.dnd;
...
import com.blazebit.blazefaces.component.dashboard.Dashboard;
...
public class DraggableRenderer extends CoreRenderer {
    ...
    public void encodeEnd(FacesContext facesContext, UIComponent component) throws IOException {
        ...
        writer.write("BlazeFaces.cw('Draggable','" + draggable.resolveWidgetVar() + "',{");
