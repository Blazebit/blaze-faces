 ...
 */
package com.blazebit.blazefaces.component.themeswitcher;

import java.io.IOException;

import javax.faces.context.FacesContext;
import javax.faces.context.ResponseWriter;
import com.blazebit.blazefaces.component.selectonemenu.SelectOneMenu;
import com.blazebit.blazefaces.component.selectonemenu.SelectOneMenuRenderer;
...
public class ThemeSwitcherRenderer extends SelectOneMenuRenderer {
	...
	protected void encodeScript(FacesContext context, SelectOneMenu menu) throws IOException {
        ...
        writer.write("BlazeFaces.cw('ThemeSwitcher','" + ts.resolveWidgetVar() + "',{");
