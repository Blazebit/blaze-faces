 ...
 */
package com.blazebit.blazefaces.component.focus;
...
public class FocusRenderer extends CoreRenderer {
	...
	protected void encodeExplicitFocus(FacesContext context, Focus focus) throws IOException {
		...
		writer.write("BlazeFaces.focus('" + clientId +"');");
		writer.write("});");
	}
	...
	protected void encodeImplicitFocus(FacesContext context, Focus focus) throws IOException {
		...
		if(invalidClientId != null){
            writer.write("BlazeFaces.focus('" + invalidClientId +"');");
		}
            ...
            if(context == null)
                ...
                writer.write("BlazeFaces.focus(null, '" + focusContext.getClientId(context) +"');");
            }
		} 
        else {
            writer.write("BlazeFaces.focus();");
        }
