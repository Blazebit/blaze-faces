 ...
 */
package com.blazebit.blazefaces.component.datatable;
...
import com.blazebit.blazefaces.component.datatable.feature.DataTableFeature;
import com.blazebit.blazefaces.component.datatable.feature.DataTableFeatureKey;
import com.blazebit.blazefaces.component.datatable.feature.SortFeature;
...
import com.blazebit.blazefaces.renderkit.DataRenderer;
...
public class DataTableRenderer extends DataRenderer {
	...
	protected void encodeScript(FacesContext context, DataTable table) throws IOException{
        ...
        writer.write("BlazeFaces.cw('DataTable','" + table.resolveWidgetVar() + "',{");
    ...
    protected void encodeThead(FacesContext context, DataTable table) throws IOException {
        ...
        if(table.isPaginator() && !table.getPaginatorPosition().equalsIgnoreCase("bottom")) {
            encodePaginatorMarkup(context, table, "top", "th", com.blazebit.blazefaces.component.UIData.PAGINATOR_TOP_CONTAINER_CLASS);
        }
    ...
    protected void encodeTFoot(FacesContext context, DataTable table) throws IOException {
        ...
        if(table.isPaginator() && !table.getPaginatorPosition().equalsIgnoreCase("top")) {
            encodePaginatorMarkup(context, table, "bottom", "td", com.blazebit.blazefaces.component.UIData.PAGINATOR_BOTTOM_CONTAINER_CLASS);
        }
