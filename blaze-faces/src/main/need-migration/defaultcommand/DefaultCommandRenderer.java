 ...
 */
package com.blazebit.blazefaces.component.defaultcommand;
...
import com.blazebit.blazefaces.component.defaultcommand.DefaultCommand;
...
public class DefaultCommandRenderer extends CoreRenderer {
    ...
    public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
        ...
        writer.write("BlazeFaces.cw('DefaultCommand','" + command.resolveWidgetVar() + "',{");
