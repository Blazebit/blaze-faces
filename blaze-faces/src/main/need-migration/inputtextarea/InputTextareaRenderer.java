...
import com.blazebit.blazefaces.component.autocomplete.AutoComplete;
import com.blazebit.blazefaces.event.AutoCompleteEvent;
...
public class InputTextareaRenderer extends InputRenderer {
	...
	protected void encodeScript(FacesContext context, InputTextarea inputTextarea) throws IOException {
        ...
        writer.write("BlazeFaces.cw('InputTextarea','" + inputTextarea.resolveWidgetVar() + "',{");
