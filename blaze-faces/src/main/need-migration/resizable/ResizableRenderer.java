 ...
 */
package com.blazebit.blazefaces.component.resizable;
...
public class ResizableRenderer extends CoreRenderer {
	...
	public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
        ...
        if(target instanceof UIGraphic)
            writer.write("$(BlazeFaces.escapeClientId('" + targetId + "')).load(function(){");
        else
            writer.write("$(function(){");
		
        writer.write("BlazeFaces.cw('Resizable','" + resizable.resolveWidgetVar() + "',{");
        ...
        if(resizable.isContainment()) writer.write(",containment:BlazeFaces.escapeClientId('" + resizable.getParent().getClientId(context) +"')");
