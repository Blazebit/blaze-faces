 ...
 */
package com.blazebit.blazefaces.component.treetable;
...
import com.blazebit.blazefaces.component.UITree;
...
public class TreeTableRenderer extends CoreRenderer {
	...
	protected void encodeScript(FacesContext context, TreeTable tt) throws IOException {
        ...
        writer.write("BlazeFaces.cw('TreeTable','" + tt.resolveWidgetVar() + "',{");
