 ...
 */
package com.blazebit.blazefaces.component.confirmdialog;
...
import com.blazebit.blazefaces.component.dialog.Dialog;
...
public class ConfirmDialogRenderer extends CoreRenderer {
	...
	protected void encodeScript(FacesContext context, ConfirmDialog dialog) throws IOException {
        ...
        writer.write("BlazeFaces.cw('ConfirmDialog','" + dialog.resolveWidgetVar() + "',{");
