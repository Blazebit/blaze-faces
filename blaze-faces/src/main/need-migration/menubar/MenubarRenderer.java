 ...
 */
package com.blazebit.blazefaces.component.menubar;
...
import com.blazebit.blazefaces.component.tieredmenu.TieredMenuRenderer;
...
public class MenubarRenderer extends TieredMenuRenderer {
	...
	protected void encodeScript(FacesContext context, AbstractMenu abstractMenu) throws IOException{
        ...
        writer.write("BlazeFaces.cw('Menubar','" + menubar.resolveWidgetVar() + "',{");
