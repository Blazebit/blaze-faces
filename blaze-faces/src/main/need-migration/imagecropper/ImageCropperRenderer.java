 ...
 */
package com.blazebit.blazefaces.component.imagecropper;
...
import com.blazebit.blazefaces.model.CroppedImage;
...
public class ImageCropperRenderer extends CoreRenderer {
	...
	protected void encodeScript(FacesContext context, ImageCropper cropper) throws IOException{
        ...
        writer.write("$(BlazeFaces.escapeClientId('" + clientId + "_image')).load(function(){");
        
        writer.write("BlazeFaces.cw('ImageCropper','" + widgetVar + "',{");
