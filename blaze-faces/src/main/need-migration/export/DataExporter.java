 ...
 */
package com.blazebit.blazefaces.component.export;
...
/*
<handler-class>
	com.blazebit.blazefaces.component.export.DataExporterTagHandler
</handler-class>
<attribute>
	...
	public void processAction(ActionEvent event){
		...
		try {
			...
			if(!(component instanceof DataTable)) {
				throw new FacesException("Unsupported datasource target:\"" + component.getClass().getName() + "\", exporter must target a BlazeFaces DataTable.");
            }
