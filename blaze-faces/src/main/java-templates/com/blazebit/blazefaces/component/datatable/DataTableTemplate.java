...
import com.blazebit.blazefaces.component.rowexpansion.RowExpansion;
import com.blazebit.blazefaces.component.row.Row;
import com.blazebit.blazefaces.component.subtable.SubTable;
import com.blazebit.blazefaces.component.contextmenu.ContextMenu;
import com.blazebit.blazefaces.component.summaryrow.SummaryRow;
...
import com.blazebit.blazefaces.event.data.PageEvent;
import com.blazebit.blazefaces.event.data.SortEvent;
import com.blazebit.blazefaces.event.data.FilterEvent;
...
import com.blazebit.blazefaces.model.SelectableDataModelWrapper;
import java.lang.reflect.Array;
import javax.faces.model.DataModel;
import javax.faces.FacesException;
import com.blazebit.blazefaces.component.UIColumn;
import javax.faces.context.FacesContext;
import com.blazebit.blazefaces.component.datatable.feature.*;
    ...
    */ 
    ...
    public Object getRowKeyFromModel(Object object) {
        ...
        if(!(model instanceof SelectableDataModel)) {
            throw new FacesException("DataModel must implement com.blazebit.blazefaces.model.SelectableDataModel when selection is enabled.");
        }
    ...
    public Object getRowData(String rowKey) {
        ...
        if(hasRowKeyVe) {
            ...
            DataModel model = getDataModel();
            if(!(model instanceof SelectableDataModel)) {
                throw new FacesException("DataModel must implement com.blazebit.blazefaces.model.SelectableDataModel when selection is enabled or you need to define rowKey attribute");
            }
