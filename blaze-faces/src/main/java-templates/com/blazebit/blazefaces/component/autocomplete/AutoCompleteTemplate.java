import com.blazebit.blazefaces.component.calendar.Calendar;
...
import javax.faces.component.behavior.Behavior;
    ...
    public void broadcast(javax.faces.event.FacesEvent event) throws javax.faces.event.AbortProcessingException {
		...
		if(me != null && event instanceof com.blazebit.blazefaces.event.AutoCompleteEvent) {
			suggestions = (List) me.invoke(facesContext.getELContext(), new Object[] {((com.blazebit.blazefaces.event.AutoCompleteEvent) event).getQuery()});
