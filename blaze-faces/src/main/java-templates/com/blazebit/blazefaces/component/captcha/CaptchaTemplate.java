...
import com.blazebit.blazefaces.util.MessageFactory;
...
import java.util.logging.Logger;
    ...
    public final static String PUBLIC_KEY = "blazefaces.PUBLIC_CAPTCHA_KEY";
    public final static String PRIVATE_KEY = "blazefaces.PRIVATE_CAPTCHA_KEY";
    public final static String INVALID_MESSAGE_ID = "blazefaces.captcha.INVALID";

    public final static String OLD_PRIVATE_KEY = "com.blazebit.blazefaces.component.captcha.PRIVATE_KEY";
    ...
    private String createPostParameters(FacesContext facesContext, Verification verification) throws UnsupportedEncodingException {
        ...
        if(oldPrivateKey != null) {
            logger.warning("PrivateKey definition on captcha is deprecated, use blazefaces.PRIVATE_CAPTCHA_KEY context-param instead");
        ...
        if(privateKey == null) {
            throw new FacesException("Cannot find private key for catpcha, use blazefaces.PRIVATE_CAPTCHA_KEY context-param to define one");
        }
