package com.blazebit.blazefaces.showcase.integration.orderlist;
...
public class OrderListIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void before() {
		driver.get(toShowcaseUrl("orderList.xhtml"));
	}
	...
	public void shouldBeAbleToMoveItems() throws InterruptedException {
		...
		assertThat(
				"Istanbul",
				equalTo(findElementByXpath(
						"//table[@id='form:basicList']/tbody/tr/td/ul/li[1]")
						.getText()));
		assertThat(
				"Ankara",
				equalTo(findElementByXpath(
						"//table[@id='form:basicList']/tbody/tr/td/ul/li[2]")
						.getText()));
		assertThat(
				"Izmir",
				equalTo(findElementByXpath(
						"//table[@id='form:basicList']/tbody/tr/td/ul/li[3]")
						.getText()));
		assertThat(
				"Antalya",
				equalTo(findElementByXpath(
						"//table[@id='form:basicList']/tbody/tr/td/ul/li[4]")
						.getText()));
		assertThat(
				"Bursa",
				equalTo(findElementByXpath(
						"//table[@id='form:basicList']/tbody/tr/td/ul/li[5]")
						.getText()));
	...
	public void shouldBeAbleToMoveItemsToTop() throws InterruptedException {
		...
		findElementByXpath(
				"//table[@id='form:customList']/tbody/tr/td/button[2]").click();
		;
	...
	public void shouldBeAbleToMoveItemsToBottom() throws InterruptedException {
		...
		findElementByXpath(
				"//table[@id='form:customList']/tbody/tr/td/button[4]").click();
		;
	...
	public void shouldBeAbleToMoveItemsToUp() throws InterruptedException {
		...
		findElementByXpath("//table[@id='form:customList']/tbody/tr/td/button")
				.click();
		;
	...
	public void shouldBeAbleToMoveItemsToDown() throws InterruptedException {
		...
		findElementByXpath(
				"//table[@id='form:customList']/tbody/tr/td/button[3]").click();
		;
