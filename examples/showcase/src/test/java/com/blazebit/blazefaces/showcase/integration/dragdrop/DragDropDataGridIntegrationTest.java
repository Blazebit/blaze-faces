...
public class DragDropDataGridIntegrationTest extends AbstractIntegrationTest {
	...
	protected static final String TEST_URL = BLAZE_SHOWCASE_UI + "dndGrid.xhtml";
	...
	public void shouldVerifyDOM() {
		...
		try {
			...
			items = findElementsBySelector(source,
	...
	public void shouldDragItemValid() throws InterruptedException {
		...
		for (int i = items.size(); i > 0; i--) {
			...
			WebElement e = findElementBySelector(source,
					".ui-draggable > .ui-widget-header:nth-last-child(n)");
			...
			try {
				...
				assertTrue("DnD DataGrid should provide valid interactions.",
						false);
			}
		}
