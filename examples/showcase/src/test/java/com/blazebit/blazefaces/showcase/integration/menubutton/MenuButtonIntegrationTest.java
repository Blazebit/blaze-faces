package com.blazebit.blazefaces.showcase.integration.menubutton;
...
public class MenuButtonIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void before() {
		driver.get(toShowcaseUrl("menubutton.xhtml"));
	}
	...
	public void shouldClickMenuItem() throws InterruptedException {
		...
		assertThat(driver.findElement(By.className("ui-growl-message"))
				.getText(), equalTo("Data saved"));
	}
	...
	public void shouldClickAndGoToPage() {
		...
		assertThat(driver.getCurrentUrl(),
				equalTo("http://www.blazebit.com/faces/"));
