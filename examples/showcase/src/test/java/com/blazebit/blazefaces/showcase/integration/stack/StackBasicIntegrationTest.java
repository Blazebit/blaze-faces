package com.blazebit.blazefaces.showcase.integration.stack;
...
public class StackBasicIntegrationTest extends AbstractIntegrationTest {
	...
	protected static final String TEST_URL = BLAZE_SHOWCASE_UI + "stack.xhtml";
	...
	public void shouldVerifyDOM() {
		...
		try {
			...
			assertTrue("Icon should be sourced.", src != null
					&& !src.trim().isEmpty());
			...
			for (WebElement e : items) {
				...
				assertTrue("Image should be sourced.", src != null
						&& !src.trim().isEmpty());
			}
	...
	public void shouldManageStack() throws InterruptedException {
		...
		assertThat("Should animate correct.", stack.getCssValue("padding-top"),
				equalTo("0px"));
