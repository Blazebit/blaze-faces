...
public class WatermarkIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		String testUrl = toShowcaseUrl("watermark.xhtml");
		driver.get(testUrl);
	}
	...
	public void shouldDisplayWatermarkInitially() throws InterruptedException {
		...
		assertThat(input.getAttribute("placeholder"),
				equalTo("Search with a keyword"));
	}

	@Test
	public void shouldSubmitEmptyTextIfInputIsEmptyWithAjax()
			throws InterruptedException {

		findElementById("form:ajax").click();
		waitUntilAjaxRequestCompletes();
		assertThat(findElementBySelector("span.ui-messages-error-detail")
				.getText(),
				equalTo("Keyword: Validation Error: Value is required."));
	}
	...
	public void shouldSubmitVsssalueWithAjax() throws InterruptedException {
		...
		findElementById("form:ajax").click();
		waitUntilAjaxRequestCompletes();
		assertTrue(findElementBySelector("span.ui-messages-info-detail")
				.getText().contains("BlazeFaces"));
	}

	@Test
	public void shouldSubmitEmptyTextIfInputIsEmptyWitRegular()
			throws InterruptedException {
