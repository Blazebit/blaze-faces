package com.blazebit.blazefaces.showcase.integration.resizable;
...
public class ResizableBasicIntegrationTest extends AbstractIntegrationTest {
	...
	public static final String TEST_URL = BLAZE_SHOWCASE_UI + "resizable.xhtml";
	...
	public void shouldBasicResize() {
		...
		assertTrue("Should resize correct.", n.width == d.width + 5
				&& n.height == d.height);
		...
		assertTrue("Should resize correct.", n.width == d.width
				&& n.height == d.height + 10);
		...
		assertTrue("Should resize correct.", n.width == d.width + 10
				&& n.height == d.height + 10);
	}
	...
	public void shouldAspectRatio() {
		...
		assertTrue("Should preserve ratio.", d.width / d.height == n.width
				/ n.height);
	}
	...
	public void shouldGhostResize() {
		...
		WebElement handle = findElementBySelector(r,
		...
		assertTrue("Should one resizable helper.",
				findElementsBySelector(".ui-resizable-helper").size() == 1);

		assertTrue("Should one resizable helper displayed.",
				findElementsBySelector(".ui-resizable-helper").get(0)
						.isDisplayed());

		Dimension n = r.getSize();

		assertTrue("Should preserve dimensions.", d.width == n.width
				&& d.height == n.height);

		action.releaseMouse();

		assertTrue("Should no resizable helper.",
				findElementsBySelector(".ui-resizable-helper").isEmpty());
	...
	public void shouldBoundryResize() {
		...
		assertTrue("Should resize max.", n.height - d.height == 50
				&& n.width - d.width == 100);
		...
		assertTrue("Should resize min.", d.height - n.height == 50
				&& d.width - n.width == 100);
	}
	...
	public void shouldGridResize() {
		...
		assertTrue("Should not resize.", n.height == d.height
				&& n.width == d.width);
		...
		assertTrue("Should resize min.", n.height - d.height == 20
				&& n.width - d.width == 20);
	}
	...
	protected void resize(WebElement e, String dir, int x, int y) {
		action.dndByOffset(
				findElementBySelector(e, ".ui-resizable-handle.ui-resizable-"
						+ dir), x, y);
	}
}
