package com.blazebit.blazefaces.showcase.integration.datagrid;
...
public class DataGridIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		String testUrl = toShowcaseUrl("datagrid.xhtml");
		driver.get(testUrl);
	}
	...
	public void shouldPaginate() throws InterruptedException {
		...
		findElementByXpath(
				"//div[@id='form:cars_paginator_top']/span[4]/span[2]").click();
