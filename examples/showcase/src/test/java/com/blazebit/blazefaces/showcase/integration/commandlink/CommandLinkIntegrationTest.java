package com.blazebit.blazefaces.showcase.integration.commandlink;
...
public class CommandLinkIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		String testUrl = toShowcaseUrl("commandLink.xhtml");
		driver.get(testUrl);
	}
	...
	@Test
	public void shouldAjaxLinkCreateValidationError()
	...
	@Test
	public void shouldNonAjaxLinkCreateValidationError()
			throws InterruptedException {
