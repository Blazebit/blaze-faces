package com.blazebit.blazefaces.showcase.integration.tooltip;
...
public class TooltipIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		String testUrl = toShowcaseUrl("tooltip.xhtml");
		driver.get(testUrl);
	...
	public void shouldShowOnFocus() throws InterruptedException {
		...
		assertThat(toolTipFocus.getText(),
				equalTo("This tooltip is displayed when input gets the focus"));
	}
	...
	public void shouldShowFade() throws InterruptedException {
		...
		assertThat(toolTipFocus.isDisplayed(), equalTo(true));
		assertThat(toolTipFocus.getText(),
				equalTo("Fade effect is used by default"));
	}
	...
	public void shouldShowSlide() throws InterruptedException {
		...
		assertThat(toolTipFocus.isDisplayed(), equalTo(true));
		assertThat(toolTipFocus.getText(),
				equalTo("This tooltip uses slide effect for the animation"));
	}
	...
	public void shouldShowGrow() throws InterruptedException {
		...
		assertThat(toolTipFocus.isDisplayed(), equalTo(true));
		assertThat(
				toolTipFocus.getText(),
				equalTo("This tooltip uses clip/explode effects for the animation"));
	}

	@Test
	public void shouldShowContent() throws InterruptedException {
		WebElement toolTipFocus = findElementById("blazeLogo");
