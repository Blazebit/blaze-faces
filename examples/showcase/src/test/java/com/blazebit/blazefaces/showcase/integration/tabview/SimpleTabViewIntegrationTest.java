...
public class SimpleTabViewIntegrationTest extends AbstractIntegrationTest {
	...
	public void shouldRenderBasicTabViewContent(){
		...
		assertTrue(findElementById("tabView:tab1Img").getAttribute("src").contains("/blaze-showcase/images/godfather/godfather1.jpg"));
		assertTrue(findElementById("tabView:tab2Img").getAttribute("src").contains("/blaze-showcase/images/godfather/godfather2.jpg"));
		assertTrue(findElementById("tabView:tab3Img").getAttribute("src").contains("/blaze-showcase/images/godfather/godfather3.jpg"));
