package com.blazebit.blazefaces.showcase.integration.starrating;
...
public class StarRatingIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		String testUrl = toShowcaseUrl("rating.xhtml");
		driver.get(testUrl);
	}
	...
	public void shouldSubmitStarRating() throws InterruptedException {
		...
		assertThat("Rating 1: 3.0",
				equalTo(findElementById("form:rating1value").getText()));
		assertThat("Rating 2: 7.0",
				equalTo(findElementById("form:rating2value").getText()));
	}
	...
	public void shouldCancelStarRating() throws InterruptedException {
		...
		findElementById("form:submit").click();
		waitUntilAjaxRequestCompletes();
		assertThat("Rating 1: 0.0",
				equalTo(findElementById("form:rating1value").getText()));
	}

	@Test
	public void shouldSubmitWithAjax() throws InterruptedException {
		findElementByXpath("//span[@id='form:ajaxRating']/span/div[6]/a")
				.click();
		waitUntilAjaxRequestCompletes();
		assertThat("You rated:5",
				equalTo(findElementBySelector("div.ui-growl-message > p")
						.getText()));
	}
