package com.blazebit.blazefaces.showcase.integration.breadcrumb;
...
public class BreadCrumbIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void before() {
		String testUrl = toShowcaseUrl("breadCrumb.xhtml");
		driver.get(testUrl);
	}
	...
	public void shouldRenderAllBreadCrumbItems() {
		...
		List<WebElement> breadCrumbs = driver.findElements(By
				.className("ui-breadcrumb"));

		WebElement firstBreadCrumb = breadCrumbs.get(0);

		List<WebElement> listItems = firstBreadCrumb.findElements(By
				.tagName("li"));
	...
	private void assertBreadCrumbItem(WebElement breadCrumbItem, String text,
			String url) {
		assertThat(
				breadCrumbItem.findElement(By.tagName("a"))
						.getAttribute("href"), endsWith(url));
		assertThat(breadCrumbItem.findElement(By.tagName("span")).getText(),
				equalTo(text));
	}
