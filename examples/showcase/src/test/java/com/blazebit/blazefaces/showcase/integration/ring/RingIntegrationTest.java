package com.blazebit.blazefaces.showcase.integration.ring;
...
public class RingIntegrationTest extends AbstractIntegrationTest {
	...
	public void shouldChangeFrontItemOfBasicRingAndShowInformations() {
		...
		assertTrue("Dialog should be displayed.",
		...
		assertTrue(choosenItem.getText().contains(
				findElementById("form:modelNo").getText()));
	}
