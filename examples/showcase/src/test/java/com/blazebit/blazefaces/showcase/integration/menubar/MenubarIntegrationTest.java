package com.blazebit.blazefaces.showcase.integration.menubar;
...
public class MenubarIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void before() {
		driver.get(toShowcaseUrl("menubar.xhtml"));
	...
	public void shouldRenderMenuBar() throws InterruptedException {
		...
		List<WebElement> menuItems = menuBar.findElements(By
	...
	public void shouldRenderSecondLevelMenu() {
		...
		WebElement newMenu = fileMenu.findElement(By.tagName("ul"))
				.findElement(By.className("ui-menuitem"));

		action.mouseHover(newMenu);

		assertThat(newMenu.findElement(By.tagName("ul")).getText(),
				equalTo("Project\nOther"));
	}
