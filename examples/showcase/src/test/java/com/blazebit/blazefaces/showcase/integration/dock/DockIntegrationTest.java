package com.blazebit.blazefaces.showcase.integration.dock;
...
public class DockIntegrationTest extends AbstractIntegrationTest {
	...
	protected static final String TEST_URL = BLAZE_SHOWCASE_UI + "dock.xhtml";
	...
	public void shouldVisitItems() throws InterruptedException {
		...
		for (WebElement e : items) {
			...
			assertTrue("Should hover dock items.", de.height > ds.height
					&& pe.x <= ps.x);
		}
	}
