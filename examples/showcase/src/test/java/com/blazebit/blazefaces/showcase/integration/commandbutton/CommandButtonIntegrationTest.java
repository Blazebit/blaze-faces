package com.blazebit.blazefaces.showcase.integration.commandbutton;
...
public class CommandButtonIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		String testUrl = toShowcaseUrl("commandButton.xhtml");
		driver.get(testUrl);
	}
	...
	protected void submitValidFormFor(String buttomId) {
		findElementById("form:firstname").sendKeys("Blaze");
		findElementById("form:surname").sendKeys("Faces");
		...
		assertThat(findElementById("form:txt1").getText(), equalTo("Blaze"));
		assertThat(findElementById("form:txt2").getText(), equalTo("Faces"));
	}

	@Test
	public void shouldAjaxButtonCreateValidationError()
	...
	@Test
	public void shouldNonAjaxButtonCreateValidationError()
			throws InterruptedException {
	...
	@Test
	public void shouldWithIconButtonCreateValidationError()
			throws InterruptedException {
	...
	@Test
	public void shouldIconOnlyButtonCreateValidationError()
			throws InterruptedException {
	...
	@Test
	public void shouldDisabledButtonShouldBeDisabled()
			throws InterruptedException {
