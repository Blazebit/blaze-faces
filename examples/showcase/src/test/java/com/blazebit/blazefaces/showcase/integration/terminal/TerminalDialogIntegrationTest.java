...
public class TerminalDialogIntegrationTest extends AbstractIntegrationTest {
    ...
    public static final String TEST_URL = BLAZE_SHOWCASE_UI + "terminalDialog.jsf";
    ...
    public void shouldManageDialogTerminal(){
        ...
        WebElement response = findElementByXpath(terminal, "//div[contains(@class, 'ui-terminal-content')]//div[contains(text(), 'Hello Blaze')]");
