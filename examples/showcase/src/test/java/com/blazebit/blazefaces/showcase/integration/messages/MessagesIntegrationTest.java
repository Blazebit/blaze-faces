package com.blazebit.blazefaces.showcase.integration.messages;
...
public class MessagesIntegrationTest extends AbstractIntegrationTest {
	...
	public void shouldShowMessages() {
		testMessagesForType("info", "BlazeFaces rocks!");
		testMessagesForType("warn", "Watch out for BlazeFaces!");
		testMessagesForType("error", "BlazeFaces makes no mistakes");
