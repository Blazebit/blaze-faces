package com.blazebit.blazefaces.showcase.integration.password;
...
public class PasswordIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		String testUrl = toShowcaseUrl("password.xhtml");
		driver.get(testUrl);
	}
	...
	public void shouldShowFeedback() throws InterruptedException {
		...
		WebElement feedbackMessage = findElementBySelector(
				findElementById("form:feedback_panel"), ".ui-password-info");
		assertThat(feedbackMessage.getText(),
	...
	public void shouldShowTurkishFeedback() throws InterruptedException {
		...
		WebElement feedbackMessage = findElementBySelector(
				findElementById("form:turkishFeedback_panel"),
				".ui-password-info");
	...
	public void shouldShowErrorMessageWhenDifferentPassEntered() {
		...
		assertTrue(message.findElement(By.tagName("div")).getAttribute("class")
				.contains("ui-messages-error"));
	}
