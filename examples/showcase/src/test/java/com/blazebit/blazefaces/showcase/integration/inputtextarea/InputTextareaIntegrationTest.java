package com.blazebit.blazefaces.showcase.integration.inputtextarea;
...
public class InputTextareaIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		driver.get(toShowcaseUrl("inputTextarea.xhtml"));
	}

	@Test
	public void shouldScrollInputTextAreaWhenTextLong() {
		WebElement inputTextarea = findElementById("form:inputarea");
