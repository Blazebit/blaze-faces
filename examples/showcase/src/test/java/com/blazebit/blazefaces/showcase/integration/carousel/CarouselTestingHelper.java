package com.blazebit.blazefaces.showcase.integration.carousel;

import org.openqa.selenium.By;
import org.openqa.selenium.WebDriver;
import org.openqa.selenium.WebElement;

import com.blazebit.blazefaces.showcase.integration.TestingUtils;
...
public class CarouselTestingHelper {
	...
	public WebElement findCarouselById(WebDriver driver, String id) {
		return driver.findElement(By.id(id)).findElement(
				By.className(CAROUSEL_CLASS));
	}
