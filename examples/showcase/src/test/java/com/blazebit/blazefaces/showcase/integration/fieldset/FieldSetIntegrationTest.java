package com.blazebit.blazefaces.showcase.integration.fieldset;
...
public class FieldSetIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		String testUrl = toShowcaseUrl("fieldset.xhtml");
		driver.get(testUrl);
	}
	...
	public void shouldShowBasicFieldSet() {
		...
		WebElement fieldSetContent = simpleFieldSet.findElement(By
	...
	public void shouldToggle() throws InterruptedException {
		...
		WebElement fieldSetContent = toggleFieldSet.findElement(By
				.className("ui-fieldset-content"));
