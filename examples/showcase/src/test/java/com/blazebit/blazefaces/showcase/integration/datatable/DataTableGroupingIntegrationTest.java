...
public class DataTableGroupingIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void before() {
		driver.get(toShowcaseUrl("datatableGrouping.xhtml"));
		headerRows = findElementById("form:salesTable").findElement(
				By.tagName("thead")).findElements(By.tagName("tr"));
	}
	...
	private void verifyColumnText(WebElement row, int columnNumber,
			String expectedText) {
