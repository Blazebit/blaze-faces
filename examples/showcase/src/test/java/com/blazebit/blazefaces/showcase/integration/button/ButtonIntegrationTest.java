package com.blazebit.blazefaces.showcase.integration.button;
...
public class ButtonIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void before() {
		String testUrl = toShowcaseUrl("button.xhtml");
		driver.get(testUrl);
	}
	...
	public void shouldNotBeAbleToClickDisabledButton() {
		...
		assertThat(driver.getCurrentUrl(), endsWith("button.xhtml"));
	}
