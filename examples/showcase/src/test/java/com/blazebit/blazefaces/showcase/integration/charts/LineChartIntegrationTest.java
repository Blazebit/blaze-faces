...
public class LineChartIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		driver.get(toShowcaseUrl("lineChart.xhtml"));
	}

	@Test
	public void chartsMustBeExist() {
		findElementById("linear").findElement(
				By.className("jqplot-lineRenderer-highlight-canvas"));
		assertTrue(findElementById("linear")
		...
		findElementById("category").findElement(
				By.className("jqplot-lineRenderer-highlight-canvas"));
		assertTrue(findElementById("category")
				.findElements(By.className("jqplot-xaxis-tick")).get(2)
				.getText().equals("2006"));
		assertTrue(findElementById("category")
				.findElements(By.className("jqplot-yaxis-tick")).get(2)
