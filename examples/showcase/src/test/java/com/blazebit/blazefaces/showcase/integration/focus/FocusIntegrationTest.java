package com.blazebit.blazefaces.showcase.integration.focus;
...
public class FocusIntegrationTest extends AbstractIntegrationTest {
	...
	@Before
	public void init() {
		String testUrl = toShowcaseUrl("focus.xhtml");
		driver.get(testUrl);
	}
	...
	@Test
	public void shouldFocusSecondInputAfterFirstInputValidAfterSubmit()
